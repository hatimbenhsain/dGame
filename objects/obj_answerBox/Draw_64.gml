...
var bubWidth=sprite_get_width(sprite_border)*image_xscale*screenScale;
var bubHeight=sprite_get_height(sprite_border)*image_yscale*screenScale;


var txt=string_copy(node.line,0,currentChar);
draw_sprite_ext(sprite_border,0,bubbleX,bubbleY,image_xscale*screenScale,image_yscale*screenScale,0,-1,1);
